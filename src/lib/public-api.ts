...
const mockProductSeeds = [
  ...
  ["avizol-100", "Avizol 100", "Авизол 100", "Avizol 100", "cat-wellness", "Капсулы 100 мг №1", "rx", "avizol-100.png"],
  ["avizol-150", "Avizol 150", "Авизол 150", "Avizol 150", "cat-wellness", "Капсулы 150 мг №1", "rx", "avizol-150.png"],
  ["avizol-50", "Avizol 50", "Авизол 50", "Avizol 50", "cat-wellness", "Капсулы 50 мг №6", "rx", "avizol-50.png"],
  ...
  ["aviflox-infusion", "Aviflox (infusion)", "Авифлокс (раствор для инфузий)", "Aviflox (infusion)", "cat-wellness", "Раствор для инфузий 500 мг/100 мл 100мл флаконы", "rx", "aviflox-infusion.png"],
  ["aviflox-tablets", "Aviflox (tablets)", "Авифлокс (таблетки)", "Aviflox (tablets)", "cat-antibiotic", "Таблетки, покрытые пленочной  оболочкой 500 мг   № 5 (1х5) (блистеры)", "rx", "aviflox-tablets.png"],
  ["aviroz-10", "Aviroz-10", "Авиroz-10", "Aviroz-10", "cat-cardio", "Таблетки покрытые пленочной оболочкой 10 мг №30", "rx", "aviroz-10.png"],
  ["aviroz-20", "Aviroz-20", "Авиroz-20", "Aviroz-20", "cat-cardio", "Таблетки покрытые пленочной оболочкой 20 мг №30", "rx", "aviroz-20.png"],
  ...
  ["m-gil-iv-solution", "M-GIL (IV solution)", "М-Гил (раствор для инфузий)", "M-GIL (IV solution)", "cat-wellness", "Раствор для внутривенного введения 5 мг/мл 100мл флаконы", "rx", "m-gil-iv-solution.png"],
  ...
  ["p-zero-gel", "P-Zero (gel)", "П-Зеро (гель)", "P-Zero (gel)", "cat-pain", "Гель  для наружного применения  30 г (тубы)", "otc", "p-zero-gel.png"],
  ...
  ["paradik-tablets", "Paradik (tablets)", "Парадик (таблетки)", "Paradik (tablets)", "cat-pain", "Таблетки 500 мг/50 мг  № 100 (10х10) (блистеры)", "otc", "paradik-tablets.png"],
  ...
  ["paradik-gel", "Paradik (gel)", "Парадик (гель)", "Paradik (gel)", "cat-pain", "Гель  для наружного применения  30 г (тубы)", "otc", "paradik-gel.png"],
  ...
  ["emcin-100", "Emcin 100", "Эмцин 100", "Emcin 100", "cat-wellness", "Раствор для инъекций 100 мг/2 мл 2 мл (флаконы)", "rx", "emcin-100.png"],
  ["emcin-500", "Emcin 500", "Эмцин 500", "Emcin 500", "cat-wellness", "Раствор для инъекций 500 мг/2 мл 2 ml (флаконы)", "rx", "emcin-500.png"],
  ...
  ["welclusa-film-coated-tablets-400-mg-100-mg-polyethylene-bottles-no-28", "Welclusa                                           Film-coated tablets 400 mg + 100 mg polyethylene bottles No. 28", "Велклуза", "Welclusa                                           Film-coated tablets 400 mg + 100 mg polyethylene bottles No. 28", "cat-gastro", "", "rx", ""],
] as const;
