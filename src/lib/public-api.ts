...
const mockProductSeeds = [
  ["amlodil-ab", "Amlodil-AB", "Амлодил-АБ", "Amlodil-AB", "cat-cardio", "Таблетки 4/5 мг ,8/10 мг № 30 (3х10) (блистеры)", "rx", "amlodil-ab.png"],
  ["avimedrol", "Avimedrol", "Авимедрол", "Avimedrol", "cat-pain", "Таблетки 4 мг,16 мг № 30 (3х10) (блистеры)", "rx", "avimedrol.png"],
  ["avicarnitine", "Avicarnitine", "Авикарнитин", "Avicarnitine", "cat-cardio", "Раствор для иньекций 200 мг/мл, 5 мл №5 (ампулы)", "rx", "avicarnitine.png"],
  ["avisil", "Avisil", "Ависил", "Avisil", "cat-pain", "Гранулы для приготовления суспензии для приема внутрь 100 мг №30 (пакетики)", "rx", "avisil.png"],
  ["avizol-50-avizol-100-avizol-150-capsules-50-mg-no-6", "Avizol 50, Avizol 100, Avizol 150 Capsules 50 mg No. 6", "Авизол 50, Авизол 100, Авизол 150 Капсулы 50 мг №6", "Avizol 50, Avizol 100, Avizol 150 Capsules 50 mg No. 6", "cat-wellness", "", "rx", "avizol-50-avizol-100-avizol-150-capsules-50-mg-no-6.png"],
  ["avantovir", "Avantovir", "Авантовир", "Avantovir", "cat-gastro", "Таблетки, покрытые пленочной оболочкой 25 мг № 30 (флаконы)", "rx", "avantovir.png"],
  ["avicet", "Avicet", "Авицет", "Avicet", "cat-wellness", "Таблетки, покрытые пленочной оболочкой 5 мг № 30 (3х10) (блистеры)", "rx", "avicet.png"],
  ...
  ["alsera", "Alsera", "Алсера", "Alsera", "cat-pain", "Таблетки, покрытые кишечнорастворимой оболочкой   № 10(1х10), №30 (3х10) (блистеры)", "rx", "alsera.png"],
  ["avicyclo", "Avicyclo", "Авицикло", "Avicyclo", "cat-antiviral", "Таблетки, покрытые пленочной  оболочкой 1000 мг   №10 (1х10) (блистеры)", "rx", "avicyclo.png"],
  ...
  ["aviflox", "Aviflox", "Авифлокс", "Aviflox", "cat-wellness", "Раствор для инфузий 500 мг/100 мл 100мл флаконы", "rx", "aviflox.png"],
  ["aviflox", "Aviflox", "Авифлокс", "Aviflox", "cat-antibiotic", "Таблетки, покрытые пленочной  оболочкой 500 мг   № 5 (1х5) (блистеры)", "rx", "aviflox.png"],
  ["aviroz-10-aviroz-20", "Aviroz-10, Aviroz-20", "Авироз- 10, Авироз- 20", "Aviroz-10, Aviroz-20", "cat-cardio", "Таблетки покрытые пленочной оболочкой блистеры №30(3x10)", "rx", "aviroz-10-aviroz-20.png"],
  ["avifer", "Avifer", "Авифер", "Avifer", "cat-wellness", "Раствор для инъекций 20 мг/мл 5мл ампулы  №1, №5(Розувастати)", "rx", "avifer.png"],
  ["ailike", "Ailike", "Айлайк", "Ailike", "cat-gastro", "Порошок шипучий для приготовления раствора для приема внутрь со вкусом апельсина №30 (1х30) (саше пакетики);   Порошок шипучий для приготовления раствора для приема внутрь со вкусом лимона №30 (1х30) (саше пакетики); (натрия бикарбонат – 2,29 г, лимонная кислота -2,16 г натрия карбонат -0,413 г;  )", "otc", "ailike.png"],
  ["bactazon", "BACTAZON", "БАКТАЗОН", "BACTAZON", "cat-wellness", "Порошок для приготовления раствора для инъекций 1.0 г + 0.5 г флаконы", "rx", "bactazon.png"],
  ["butafen-250", "Butafen 250", "Бутафен 250", "Butafen 250", "cat-pain", "Таблетки 250 мг   № 20 (2х10) (блистеры)", "rx", "butafen-250.png"],
  ["butafen-100", "Butafen 100", "Бутафен 100", "Butafen 100", "cat-pain", "Порошок для приготовления раствора для приема внутрь 100 мг №15 (пакетики)", "rx", "butafen-100.png"],
  ["jaraflu", "Jaraflu", "Жарафлю", "Jaraflu", "cat-wellness", "Порошок для приготовления раствора для приема внутрь дозированный со вкусами апельсина и лимона 22 мг №10 (пакетики)", "otc", "jaraflu.png"],
  ...
  ["gepa-l", "Gepa-L", "Гепа-Л", "Gepa-L", "cat-gastro", "Гранулы для приготовления раствора для приема внутрь 5г №30 (пакетики)", "rx", "gepa-l.png"],
  ...
  ["cardifors", "CARDIFORS", "КАРДИФОРС", "CARDIFORS", "cat-cardio", "Порошок для приготовления раствора для инфузий 1 г флаконы", "rx", "cardifors.png"],
  ...
  ["m-gil", "M-GIL", "М-ГИЛ", "M-GIL", "cat-wellness", "Раствор для внутривенного введения 5 мг/мл 100мл флаконы", "rx", "m-gil.png"],
  ["m-gil", "M-GIL", "М-ГИЛ9", "M-GIL", "cat-wellness", "Таблетки, покрытые пленочной оболочкой 250 мг № 20 (2х10) (блистеры)", "rx", "m-gil.png"],
  ...
  ["maxicol-drops", "MAXICOL Drops", "МАКСИКОЛ Капли", "MAXICOL Drops", "cat-wellness", "для приема внутрь 15мл Флакон темного стекла В комплекте с пробка-капельница", "rx", "maxicol-drops.png"],
  ["meropenem-avantika", "MEROPENEM AVANTIKA", "МЕРОПЕНЕМ АВАНТИКА", "MEROPENEM AVANTIKA", "cat-wellness", "Порошок для приготовления раствора для инъекций 1000мг флаконы", "rx", "meropenem-avantika.png"],
  ...
  ["macro-g", "Macro-G", "Макро-Джи", "Macro-G", "cat-gastro", "Порошок для приготовления раствора для приема внутрь со вкусом апельсина 10 г по 10,741 г №10 (пакетики)", "otc", "macro-g.png"],
  ["morecin", "Morecin", "Морецин", "Morecin", "cat-wellness", "Гранулы для приготовления раствора для приема внутрь 3г №1 (пакетики)", "rx", "morecin.png"],
  ["neuro-g", "Neuro-G", "Нейро-Джи", "Neuro-G", "cat-pain", "Таблетки, покрытые пленочной оболочкой 300 мг/500 мкг № 20 (2х10) (блистеры)", "rx", "neuro-g.png"],
  ["nevikor-5", "Nevikor-5", "Невикор-5", "Nevikor-5", "cat-cardio", "Таблетки 5 мг  № 30 (3х10) (блистеры)", "rx", "nevikor-5.png"],
  ["nevikor-10", "Nevikor-10", "Невикор-10", "Nevikor-10", "cat-cardio", "Таблетки 10 мг  № 30 (3х10) (блистеры)", "rx", "nevikor-10.png"],
  ["omeprazole", "Omeprazole", "Омепразол", "Omeprazole", "cat-gastro", "Капсулы 20 мг  № 30 (3х10), №100 (10х10) (стрипы)", "rx", "omeprazole.png"],
  ["orlox", "Orlox", "Орлокс", "Orlox", "cat-gastro", "Таблетки, покрытые пленочной  оболочкой 200 мг+ 500 мг  №10 (1х10) (блистеры)", "rx", "orlox.png"],
  ["p-zero", "P-Zero", "П-Зеро", "P-Zero", "cat-pain", "Гель  для наружного применения  30 г (тубы)", "otc", "p-zero.png"],
  ["p-zero", "P-Zero", "П-Зеро", "P-Zero", "cat-pain", "Раствор для инъекций 30 мг/мл 1мл ампулы №10", "rx", "p-zero.png"],
  ["paradik", "Paradik", "Парадик", "Paradik", "cat-pain", "Таблетки 500 мг/50 мг  № 100 (10х10) (блистеры)", "otc", "paradik.png"],
  ["p-zero", "P-Zero", "П-Зеро", "P-Zero", "cat-pain", "Таблетки, покрытые пленочной оболочкой 10 мг № 10 (1х10),№20 (2х10),№30 (3х10) (блистеры)", "rx", "p-zero.png"],
  ["paradik", "Paradik", "Парадик", "Paradik", "cat-pain", "Гель  для наружного применения  30 г (тубы)", "otc", "paradik.png"],
  ["panten", "Panten", "Пантен", "Panten", "cat-gastro", "Капсулы кишечнорастворимые 300мг №20 (2х10) (блистеры)", "rx", "panten.png"],
  ["pentaza-40", "Pentaza-40", "Пентаза- 40", "Pentaza-40", "cat-gastro", "Таблетки, покрытые кишечнорастворимой оболочкой 40 мг №30 (3х10) (блистеры)", "otc", "pentaza-40.png"],
  ["ranit", "Ranit", "Ранит", "Ranit", "cat-gastro", "Таблетки, покрытые пленочной оболочкой 150 мг №100 (10х10) (блистеры)", "otc", "ranit.png"],
  ["si-zol", "SI-ZOL", "СИ-ЗОЛ", "SI-ZOL", "cat-wellness", "Крем для наружного применения 0,05%,  15 г №1 (тубы)", "otc", "si-zol.png"],
  ["stressi", "STRESSI", "СТРЕССИ", "STRESSI", "cat-pain", "Капсулы блистеры №20(2x10)Экстракт валерианы (Valeriana walliach) 200 мг Экстракт ашваганды (Withania somnifera) 150 мг | Экстракт вьюнка смолоносного (Convolvulus pluricaulis) 50 мг | Экстракт бакопы (Весора moniery) 50 мг | Экстракт центеллы азиатской (Centella asiatica) 50 мг", "otc", "stressi.png"],
  ["semilopa", "SEMILOPA", "СЕМИЛОПА", "SEMILOPA", "cat-wellness", "Таблетки, покрытые пленочной оболочкой 2мг/125 мг  №6 (1х6) (блистеры)", "otc", "semilopa.png"],
  ["super-day-and-night", "SUPER DAY AND NIGHT", "СУПЕР ДЕНЬ И НОЧЬ", "SUPER DAY AND NIGHT", "cat-pain", "5 таблеток с пролонгированным высвобождением, 5 таблеток покрытых пленочной оболочкой   №10 (5+5) (блистеры)", "otc", "super-day-and-night.png"],
  ["trinazol", "Trinazol", "Триназол", "Trinazol", "cat-wellness", "Крем для наружного применения   15 г (тубы)", "otc", "trinazol.png"],
  ["telkor", "Telkor", "Телкор", "Telkor", "cat-cardio", "Таблетки 40 мг №30 (3х10) (блистеры)", "rx", "telkor.png"],
  ["tadal", "Tadal", "Тадал", "Tadal", "cat-wellness", "Таблетки, покрытые пленочной оболочкой 20 мг +60 мг  №4 (1х4) (блистеры)", "otc", "tadal.png"],
  ["ursodoks", "Ursodoks", "Урсодокс", "Ursodoks", "cat-gastro", "Урсодезоксихолевая кислота) | Капсулы  250мг №20 (2х10), №50 (5х10) (блистеры)", "rx", "ursodoks.png"],
  ["favipiravir-avantika", "Favipiravir Avantika", "Фавипиравир Авантика", "Favipiravir Avantika", "cat-wellness", "Таблетки, покрытые пленочной оболочкой 200 мг  №42 (7х6) (блистеры)", "rx", "favipiravir-avantika.png"],
  ...
  ["cyclogan-500", "Cyclogan-500", "Циклоган-500", "Cyclogan-500", "cat-antiviral", "Капсулы  500мг №30 (3х10) (блистеры)", "rx", "cyclogan-500.png"],
  ...
  ["enoxa--40", "ENOXA -40", "ЭНОКСА -40 /60/80", "ENOXA -40", "cat-cardio", "Раствор для инъекций 4000 анти-Ха МЕ/0,4 мл предварительно заполненный шприц", "rx", "enoxa--40.png"],
  ["emcin-injection-solution-100-mg2-ml-500-mg2-ml-2-ml", "EMCIN                              Injection solution 100 mg/2 ml, 500 mg/2 ml 2 ml", "ЭМЦИН", "EMCIN                              Injection solution 100 mg/2 ml, 500 mg/2 ml 2 ml", "cat-wellness", "", "rx", "emcin-injection-solution-100-mg2-ml-500-mg2-ml-2-ml.png"],
  ["aviten-20-lyophilized-powder-for-preparation-of-injection-solution-20-mg-complete-with-solvent---water-for-injection-2-ml-2-ml", "Aviten 20                              lyophilized powder for preparation of injection solution 20 mg complete with solvent - water for injection 2 ml 2 ml", "Авитен 20               лиофилизированный порошок для приготовления раствора для инъекций 20 мг в комплекте с растворителем - вода для инъекций 2мл 2 мл", "Aviten 20                              lyophilized powder for preparation of injection solution 20 mg complete with solvent - water for injection 2 ml 2 ml", "cat-pain", "", "rx", "aviten-20-lyophilized-powder-for-preparation-of-injection-solution-20-mg-complete-with-solvent---water-for-injection-2-ml-2-ml.png"],
  ["welclusa-film-coated-tablets-400-mg-100-mg-polyethylene-bottles-no-28", "Welclusa                                           Film-coated tablets 400 mg + 100 mg polyethylene bottles No. 28", "Велклуза", "Welclusa                                           Film-coated tablets 400 mg + 100 mg polyethylene bottles No. 28", "cat-gastro", "", "rx", "welclusa-film-coated-tablets-400-mg-100-mg-polyethylene-bottles-no-28.png"],
] as const;

export const mockProducts: Product[] = mockProductSeeds.map(([slug, uz, ru, en, categoryId, dosage, prescriptionType, imageUrl]) => ({
  id: slug,
  title: {uz, ru, en},
  slug,
  categoryId,
