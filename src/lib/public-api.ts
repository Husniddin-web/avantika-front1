...
const mockProductSeeds = [
  ...
  ["aviten-20-lyophilized-powder-for-preparation-of-injection-solution-20-mg-complete-with-solvent---water-for-injection-2-ml-2-ml", "Aviten 20                              lyophilized powder for preparation of injection solution 20 mg complete with solvent - water for injection 2 ml 2 ml", "Авитен 20               лиофилизированный порошок для приготовления раствора для инъекций 20 мг в комплекте с растворителем - вода для инъекций 2мл 2 мл", "Aviten 20                              lyophilized powder for preparation of injection solution 20 mg complete with solvent - water for injection 2 ml 2 ml", ["cat-pain", "cat-wellness"], "", "rx", ""],
  ["welclusa-film-coated-tablets-400-mg-100-mg-polyethylene-bottles-no-28", "Welclusa                                           Film-coated tablets 400 mg + 100 mg polyethylene bottles No. 28", "Велклуза", "Welclusa                                           Film-coated tablets 400 mg + 100 mg polyethylene bottles No. 28", ["cat-gastro", "cat-antiviral", "cat-pain"], "", "rx", ""],
] as const;
