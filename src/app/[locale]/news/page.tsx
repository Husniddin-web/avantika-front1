...
export async function generateMetadata({
  ...
  const t = await getTranslations({locale: locale as "uz" | "ru" | "en", namespace: "NewsPage"});
  ...
  return {
    ...
    alternates: {
      ...
      languages: Object.fromEntries(
        routing.locales.map((loc) => [loc, `${SITE_URL}/${loc}/news`])
      ),
    },
    openGraph: {url: `${SITE_URL}/${locale}/news`, title},
  };
}
